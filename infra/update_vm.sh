#!/bin/bash
# ============================================================================
# update_vm.sh — Pull latest code from GitHub and redeploy all services.
#
# Run this on the VM any time you push new changes from your Mac:
#   bash infra/update_vm.sh
#
# Assumes deploy_vm.sh was already run once to set up the VM from scratch.
# ============================================================================
set -e
...
# ── Step 4: Node deps — BFF ───────────────────────────────────────────────
echo ""
echo "===== [4/6] Node deps — BFF ====="
cd "$REPO_DIR/expense-copilot/bff"
...
echo "  concur-stub restarted."
sleep 3

sudo systemctl restart layer2
echo "  layer2 restarted."
sleep 3
